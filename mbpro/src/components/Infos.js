    ...
    >
      <div className="flex  mb-[20vh] mt-[5vw] mr-[20vw] justify-center items-center h-[50vw] w-[50vw] border-2 rounded-lg  bg-[#830049]/80 z-51">
        <div className="flex flex-col items-start  bg-[#830049] rounded-lg w-[90%] h-[90%]">
          <h1 className="text-white text-[2.5vw] mx-auto pt-[3vh]">À Propos</h1>
      ...
      <div className="flex absolute mt-[40vw] mb-[30vw] ml-[30vw] justify-center items-center h-[35vw] w-[50vw] border-2 border-[#830049] rounded-lg  bg-white/80 ">
        <div className="relative flex flex-col items-center bg-white rounded-lg w-[90%] h-[90%] justify-evenly">
          <div className="flex flex-col items-center justify-evenly w-[75%] h-[75%]">
            <p className=" text-[1.4vw] ">
              ...
              dans{" "}
              <font color="830049">
                la création, la gestion et le develeppoment de votre entreprise
              </font>
              . Depuis plus de 4 ans nous permettons à une trentaine de petites
              et moyennes entreprises d'aborder avec sérénité les échéances que
              sont les bilans, les fiches de paies et les contrôles. N'hesitez
              pas à{" "}
              <Link
                to="contacts"
                smooth={true}
